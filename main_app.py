...
if tabs == 'Introduction':
    ...
    st.markdown("1a) How do long-term interest rates affect the stock market (return rate)? It aims to understand how fluctuations in interest rates influence stock market performance.")
